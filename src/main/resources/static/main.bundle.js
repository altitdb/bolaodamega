...
var RaffledComponent = (function () {
    ...
    RaffledComponent.prototype.ngOnInit = function () {
        ...
        this._raffledService.findLastGame().subscribe(function (suc) {
            ...
            _this.tenderDate = suc.tenderDate;
