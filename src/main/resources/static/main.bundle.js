...
var AppComponent = (function () {
    function AppComponent(http) {
        ...
        this.data = {};
        this.dataSource = {};
        this.apiUrl = 'http://localhost:8080/api/statistics';
        this.getStatistics();
        this.dataSource = new __WEBPACK_IMPORTED_MODULE_3__angular_material__["a" /* MatTableDataSource */](this.data);
    }
    AppComponent.prototype.getData = function () {
        return this.http.get(this.apiUrl).map(function (response) { return response.json(); });
    };
